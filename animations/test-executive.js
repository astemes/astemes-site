/* Astemes "Test Executive" — the default hero animation module.
   Registers with the animation loader (animations/loader.js), which mounts it into the
   hero stage. This is the default / most representative animation. */
(function () {
  var SVG =
  ...
  window.AstemesAnim.register({
    id: 'test-executive',
    name: 'Test Executive',
    weight: 3,            // most representative — favoured in the random rotation
    isDefault: true,
